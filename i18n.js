const i18n = {
    data: {
        ...
        'zh-hk': {
            ...
            'clear-button': '清除',
            'send-button': '傳送',
            'input-placeholder-text': '喺度打文字',
            'input-placeholder-hex': '喺度打十六進制',
        ...
        'ja': {
            ...
            'input-placeholder-hex': '十六進数を入力してください',
            'encoding-select': '符号化方式：',
            'format-select': '表示形式：',
            'format-select-option-hex': '十六進数',
        ...
        'ko': {
            ...
            'clear-button': '지우기',
            'send-button': '전송',
            'input-placeholder-text': '텍스트를 입력하세요',
            'input-placeholder-hex': '십육진법을 입력하세요',
            'encoding-select': '부호화 방식: ',
            'format-select': '표시 형식: ',
